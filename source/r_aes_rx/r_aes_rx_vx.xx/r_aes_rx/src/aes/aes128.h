...
/***********************************************************************************************************************
 * @file         aes128.h
 * @brief        Define API function for AES-128
 **********************************************************************************************************************/
...
/***********************************************************************************************************************
 * Declaration  : static uint32_t Load32(uint8_t *x)
 ...
 * Description  : The R_Aes_128_Cbcenc() function encrypts the plain text at a specified address (the first argument
 * "pdat") by using the expanded key (the forth argument "ekey") with initialization vector (the third argument "ivec")
 * in CBC mode and outputs cipher text to a designated address (the second argument "cdat"). The amount specified by
 * the number of blocks (the fifth argument "block" and each block is 16 byte in length) is encrypted. The "ivec" is
 * used as 16-byte work area. When the block encryption has finished, the last encrypted block data would be output to
 * the "ivec".
 * Arguments    : pdat Plain text area (block * 16 byte).
 *                cdat Cipher text area (block * 16 byte).
 *                ivec Initialization vector area (16 byte).
 *                ekey Expanded key area (176 byte).
 ...
 * Description  : The R_Aes_128_Cbcdec() function decrypts the cipher text at a specified address (the first argument
...
#endif /* defined__SUPPORT_AES128__ */
