...
#endif /* defined __TARGET_CPU_CORTEX_A9 */
...
/***********************************************************************************************************************
 Global variables
 **********************************************************************************************************************/
const mw_version_t far R_gcm_version =
{
    __COMPILER_VER__ ,
    "GCM Library version "__GCM_VERSION__" for "__TARGET_CPU__".("__DATE__", "__TIME__")\n"
};
