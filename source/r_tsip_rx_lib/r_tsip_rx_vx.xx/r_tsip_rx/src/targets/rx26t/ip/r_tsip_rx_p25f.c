...
e_tsip_err_t R_TSIP_VerifyFirmwareMacFinalSub(uint32_t *InData_Program, uint32_t *InData_MAC, uint32_t MAX_CNT)
{
    ...
    RX26T_function001(change_endian_long(0x4b321812u), change_endian_long(0x549abb1du), change_endian_long(0xab87e7e8u), change_endian_long(0xf148be99u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        TSIP.REG_13CH.WORD = 0x000002ffu;
        RX26T_function003(change_endian_long(0xddbabd86u), change_endian_long(0x0948e8d5u), change_endian_long(0x6a3147f9u), change_endian_long(0x56e85800u));
    ...
    {
        RX26T_function003(change_endian_long(0xef0d3eebu), change_endian_long(0x8b3efb07u), change_endian_long(0x03a52089u), change_endian_long(0x95dd2d22u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX26T/RX26T_p25f.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
