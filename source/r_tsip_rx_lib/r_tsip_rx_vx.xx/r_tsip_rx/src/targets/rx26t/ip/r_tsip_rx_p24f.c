...
e_tsip_err_t R_TSIP_GenerateFirmwareMacFinalSub(uint32_t *InData_UpProgram, uint32_t *InData_UpMAC, uint32_t *OutData_Program, uint32_t *OutData_MAC, uint32_t MAX_CNT)
{
    ...
    {
        RX26T_function001(change_endian_long(0xd481abb3u), change_endian_long(0x363394b4u), change_endian_long(0x66aa5882u), change_endian_long(0x749732ffu));
        ...
        RX26T_function002(change_endian_long(0x95e16984u), change_endian_long(0xe4388207u), change_endian_long(0xa3eda5feu), change_endian_long(0x56b12a2cu));
    }
    RX26T_function001(change_endian_long(0xec16d620u), change_endian_long(0x44c1dc50u), change_endian_long(0xcf380d12u), change_endian_long(0x0763e006u));
    TSIP.REG_104H.WORD = 0x00000361u;
    TSIP.REG_A4H.WORD = 0x00d049adu;
    /* WAIT_LOOP */
    while (1u != TSIP.REG_104H.BIT.B31)
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX26T_function001(change_endian_long(0x4e142005u), change_endian_long(0xe2b815d4u), change_endian_long(0x1c392747u), change_endian_long(0x352cd6f1u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX26T_function003(change_endian_long(0xa258646eu), change_endian_long(0x9d8eaf59u), change_endian_long(0x7bf244dcu), change_endian_long(0x2eaf2d61u));
    ...
    {
        RX26T_function001(change_endian_long(0xf48a5fe8u), change_endian_long(0x80cfd8b6u), change_endian_long(0x6c5d87c8u), change_endian_long(0x39e8fd93u));
        ...
        RX26T_function003(change_endian_long(0x8acb0527u), change_endian_long(0xedd91741u), change_endian_long(0xf86b6398u), change_endian_long(0x0988f727u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX26T/RX26T_p24f.prc
 *********************************************************************************************************************/
