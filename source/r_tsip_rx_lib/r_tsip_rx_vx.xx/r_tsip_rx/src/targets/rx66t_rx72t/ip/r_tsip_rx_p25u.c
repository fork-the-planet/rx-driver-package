...
*******************************************************************************************************************/ /**
* @details       RX66T Program integrity check Update
...
e_tsip_err_t R_TSIP_VerifyFirmwareMacUpdateSub(uint32_t *InData_Program, uint32_t MAX_CNT)
{
    ...
    RX66T_RX72T_function002(change_endian_long(0xe12c6075u), change_endian_long(0x65bf479du), change_endian_long(0xf31d12e6u), change_endian_long(0x9386120eu));
    #if TSIP_MULTI_THREADING == 1
...
/**********************************************************************************************************************
 End of function ./input_dir/RX66T/RX66T_p25u.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
