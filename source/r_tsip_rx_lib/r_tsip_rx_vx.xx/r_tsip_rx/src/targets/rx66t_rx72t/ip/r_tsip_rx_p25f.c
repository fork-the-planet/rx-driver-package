...
*******************************************************************************************************************/ /**
* @details       RX66T Program integrity check Final
...
e_tsip_err_t R_TSIP_VerifyFirmwareMacFinalSub(uint32_t *InData_Program, uint32_t *InData_MAC, uint32_t MAX_CNT)
{
    ...
    RX66T_RX72T_function001(change_endian_long(0x35f7900fu), change_endian_long(0xbc5f79a3u), change_endian_long(0x9a2d6d0eu), change_endian_long(0x681d60e0u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        TSIP.REG_13CH.WORD = 0x000002ffu;
        RX66T_RX72T_function003(change_endian_long(0xb5b51a53u), change_endian_long(0x0859eafcu), change_endian_long(0xff028f98u), change_endian_long(0x763a19fdu));
    ...
    {
        RX66T_RX72T_function003(change_endian_long(0xa74a2b7du), change_endian_long(0xd676c748u), change_endian_long(0xe6e1f1deu), change_endian_long(0x1221e166u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX66T/RX66T_p25f.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
