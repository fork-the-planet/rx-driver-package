...
e_tsip_err_t R_TSIP_GenerateFirmwareMacInitSub(uint32_t *InData_KeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV)
{
    ...
    else
    {
        ...
        RX66T_RX72T_function002(change_endian_long(0x4fe56cf3u), change_endian_long(0x509b8518u), change_endian_long(0x4715ba37u), change_endian_long(0x0c9b5ca1u));
        #if TSIP_MULTI_THREADING == 1
        TSIP_MULTI_THREADING_UNLOCK_FUNCTION();
        #endif /* TSIP_MULTI_THREADING == 1 */
        return TSIP_SUCCESS;
...
/**********************************************************************************************************************
 End of function ./input_dir/RX66T/RX66T_p24i.prc
 *********************************************************************************************************************/
