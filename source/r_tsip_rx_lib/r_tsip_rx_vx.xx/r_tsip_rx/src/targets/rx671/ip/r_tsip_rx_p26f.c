...
e_tsip_err_t R_TSIP_VerifyFirmwareMacFinalSub(uint32_t *InData_Program, uint32_t *InData_MAC, uint32_t MAX_CNT)
{
    ...
    RX671_func100(change_endian_long(0x0ca6ba79u), change_endian_long(0x66526d45u), change_endian_long(0x79cdec92u), change_endian_long(0x3c2ff40du));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        TSIP.REG_13CH.WORD = 0x000002ffu;
        RX671_func102(change_endian_long(0x1a0d7dbcu), change_endian_long(0x6c63511du), change_endian_long(0x98b3cd42u), change_endian_long(0x87e54012u));
    ...
    {
        RX671_func102(change_endian_long(0x6be3f271u), change_endian_long(0xa5f2ff86u), change_endian_long(0x553dfe63u), change_endian_long(0x8bf0a82fu));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p26f.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
