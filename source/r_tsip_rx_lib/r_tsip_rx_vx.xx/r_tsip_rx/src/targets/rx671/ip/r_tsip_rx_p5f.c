...
e_tsip_err_t R_TSIP_EcdhP256SshKeyDerivationSub(uint32_t *InData_KeyIndexType, uint32_t *InData_KeyIndex, uint32_t *InData_PaddedMsg, uint32_t *InData_PaddedMsgLength, uint32_t *OutData_KeyIndex1, uint32_t *OutData_KeyIndex2, uint32_t *OutData_KeyIndex3, uint32_t *OutData_KeyIndex4, uint32_t *OutData_IV1, uint32_t *OutData_IV2)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0xcbbd76c7u), change_endian_long(0xd57c36ceu), change_endian_long(0x79fcd58bu), change_endian_long(0x80df8fedu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x6c8976dbu), change_endian_long(0x55fab19au), change_endian_long(0xbb4f5673u), change_endian_long(0x62d68cd5u));
    ...
    else
    {
        ...
        RX671_func100(change_endian_long(0x445b480du), change_endian_long(0x9b20e8fbu), change_endian_long(0x5891b0f5u), change_endian_long(0x49a3553du));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX671_func102(change_endian_long(0x92af3d8eu), change_endian_long(0xe354e5cdu), change_endian_long(0x16394aa6u), change_endian_long(0xbc113c3du));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        else
        {
            ...
            RX671_func100(change_endian_long(0x623a43f1u), change_endian_long(0x1a8c1c42u), change_endian_long(0xdc64211du), change_endian_long(0xbb1b7c19u));
            ...
            for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 16)
            {
                ...
                RX671_func101(change_endian_long(0x20f8bcc2u), change_endian_long(0xec977134u), change_endian_long(0x864396f1u), change_endian_long(0xbf0c07b5u));
            }
            RX671_func100(change_endian_long(0x6f704ed4u), change_endian_long(0x5b30118bu), change_endian_long(0x79fe27aeu), change_endian_long(0x2e3f9217u));
            ...
            for (iLoop = iLoop; iLoop < S_RAM[0]; iLoop = iLoop + 1)
            {
                ...
                RX671_func101(change_endian_long(0xf67d463du), change_endian_long(0x90ee78e3u), change_endian_long(0x4ae73119u), change_endian_long(0x2c5cba45u));
            }
            RX671_func100(change_endian_long(0x61e98164u), change_endian_long(0x32788082u), change_endian_long(0x1256b3aeu), change_endian_long(0x1bca9ee5u));
            ...
            for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 1)
            {
                ...
                TSIP.REG_ECH.WORD = 0x00002fe0u;
                RX671_func101(change_endian_long(0xdea957d1u), change_endian_long(0x5420612fu), change_endian_long(0x4b7f2795u), change_endian_long(0xb2ccaffeu));
            }
            RX671_func100(change_endian_long(0xf724bce2u), change_endian_long(0x87524a50u), change_endian_long(0x5f386b0du), change_endian_long(0x5e0e7328u));
            TSIP.REG_ECH.WORD = 0x38000a1fu;
            TSIP.REG_E0H.WORD = 0x00000080u;
            TSIP.REG_1CH.WORD = 0x00260000u;
            TSIP.REG_1CH.WORD = 0x00402000u;
            ...
            for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 1)
            {
                ...
                TSIP.REG_ECH.WORD = 0x00002fe0u;
                RX671_func101(change_endian_long(0x92073f84u), change_endian_long(0xcc6a9bd5u), change_endian_long(0xd1db1e05u), change_endian_long(0xc92b24fdu));
            }
            RX671_func100(change_endian_long(0x16951d46u), change_endian_long(0x28ddea00u), change_endian_long(0xa20e497fu), change_endian_long(0x2cfb8223u));
            ...
            for (iLoop = 0; iLoop < 6; iLoop = iLoop + 1)
            {
                ...
                for (jLoop = 0; jLoop < S_RAM[0]; jLoop = jLoop + 1)
                {
                    ...
                    RX671_func101(change_endian_long(0xfe1abb57u), change_endian_long(0xddcd24bcu), change_endian_long(0x31a70207u), change_endian_long(0xa0ebfad1u));
                }
                ...
                TSIP.REG_ECH.WORD = 0x00002e20u;
                TSIP.REG_ECH.WORD = 0x00002fe0u;
                RX671_func101(change_endian_long(0x57dab101u), change_endian_long(0xc0087cd9u), change_endian_long(0x9cbe83c2u), change_endian_long(0xccfea57du));
            }
            RX671_func100(change_endian_long(0x2d6fd1e3u), change_endian_long(0x0937c041u), change_endian_long(0xeb2272eeu), change_endian_long(0xf3e78e79u));
            ...
            TSIP.REG_1CH.WORD = 0x00402000u;
            RX671_func103();
            RX671_func100(change_endian_long(0x4f502e72u), change_endian_long(0x449c6cdbu), change_endian_long(0xd505a7c7u), change_endian_long(0xf5b4b6ccu));
            ...
            TSIP.REG_1CH.WORD = 0x00001800u;
            RX671_func103();
            RX671_func100(change_endian_long(0x62b3160cu), change_endian_long(0x13299dcdu), change_endian_long(0xd0eeed6bu), change_endian_long(0xf85480a9u));
            TSIP.REG_104H.WORD = 0x00000052u;
            TSIP.REG_C4H.WORD = 0x01000c84u;
            /* WAIT_LOOP */
            while (1u != TSIP.REG_104H.BIT.B31)
            ...
            TSIP.REG_1CH.WORD = 0x00001800u;
            RX671_func103();
            RX671_func100(change_endian_long(0x76dd13e7u), change_endian_long(0x42601f5cu), change_endian_long(0xfd78592du), change_endian_long(0xb3429d33u));
            TSIP.REG_104H.WORD = 0x00000052u;
            TSIP.REG_C4H.WORD = 0x01000c84u;
            /* WAIT_LOOP */
            while (1u != TSIP.REG_104H.BIT.B31)
            ...
            TSIP.REG_E0H.WORD = 0x00000080u;
            TSIP.REG_1CH.WORD = 0x00A60000u;
            RX671_func100(change_endian_long(0x71516705u), change_endian_long(0x3e0ab1cau), change_endian_long(0x67f3c698u), change_endian_long(0xa49ec609u));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX671_func100(change_endian_long(0x172c5853u), change_endian_long(0x73a753b8u), change_endian_long(0xa451555du), change_endian_long(0x4fc0f707u));
                TSIP.REG_C4H.WORD = 0x000c2b0du;
                ...
                RX671_func100(change_endian_long(0x89ffe75eu), change_endian_long(0xe9a3d352u), change_endian_long(0x459731f4u), change_endian_long(0x3c354bd8u));
                TSIP.REG_C4H.WORD = 0x000c2b0du;
                ...
                RX671_func101(change_endian_long(0x9835489bu), change_endian_long(0x6acd5355u), change_endian_long(0xc646c05du), change_endian_long(0x25f59844u));
            }
            else
            {
                ...
                TSIP.REG_E0H.WORD = 0x00000080u;
                TSIP.REG_1CH.WORD = 0x00260000u;
                RX671_func100(change_endian_long(0xf96401e3u), change_endian_long(0x31adf1c2u), change_endian_long(0xe4bba45au), change_endian_long(0x4df47c81u));
                TSIP.REG_1CH.WORD = 0x00400000u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
                if (1u == (TSIP.REG_1CH.BIT.B22))
                {
                    RX671_func100(change_endian_long(0xd916ed9fu), change_endian_long(0x90b6078au), change_endian_long(0x38071095u), change_endian_long(0xea82a538u));
                    TSIP.REG_C4H.WORD = 0x000c2b0du;
                    ...
                    RX671_func100(change_endian_long(0xd6ece01eu), change_endian_long(0xb5a678a3u), change_endian_long(0x9276ef29u), change_endian_long(0x4b046349u));
                    TSIP.REG_C4H.WORD = 0x000c2b0du;
                    ...
                    RX671_func100(change_endian_long(0x848e8629u), change_endian_long(0xbc4c6543u), change_endian_long(0x08207db6u), change_endian_long(0x72f5b7fbu));
                    TSIP.REG_C4H.WORD = 0x000c2b0du;
                    TSIP.REG_E0H.WORD = 0x81040080u;
                    TSIP.REG_00H.WORD = 0x00002813u;
                    /* WAIT_LOOP */
                    ...
                    OutData_KeyIndex3[10] = TSIP.REG_100H.WORD;
                    OutData_KeyIndex3[11] = TSIP.REG_100H.WORD;
                    RX671_func100(change_endian_long(0xaa931fd0u), change_endian_long(0x28236d44u), change_endian_long(0xfb278b51u), change_endian_long(0x333dd91cu));
                    TSIP.REG_C4H.WORD = 0x000c2b0du;
                    TSIP.REG_E0H.WORD = 0x81040000u;
                    TSIP.REG_00H.WORD = 0x00002813u;
                    /* WAIT_LOOP */
                    ...
                    OutData_KeyIndex4[10] = TSIP.REG_100H.WORD;
                    OutData_KeyIndex4[11] = TSIP.REG_100H.WORD;
                    RX671_func101(change_endian_long(0x9cec4761u), change_endian_long(0x1434031fu), change_endian_long(0x0415e594u), change_endian_long(0x61b5b0e3u));
                }
                else
                {
                    RX671_func100(change_endian_long(0x404f8529u), change_endian_long(0x4243b164u), change_endian_long(0x1a8f038du), change_endian_long(0xba56b163u));
                    TSIP.REG_C4H.WORD = 0x000c2b0du;
                    TSIP.REG_E0H.WORD = 0x81040180u;
                    TSIP.REG_00H.WORD = 0x00002813u;
                    /* WAIT_LOOP */
                    ...
                    RX671_func100(change_endian_long(0xf9c0d5b9u), change_endian_long(0xeefc31edu), change_endian_long(0xfc800883u), change_endian_long(0x6c691a9eu));
                    TSIP.REG_C4H.WORD = 0x000c2b0du;
                    TSIP.REG_E0H.WORD = 0x81040100u;
                    TSIP.REG_00H.WORD = 0x00002813u;
                    /* WAIT_LOOP */
                    ...
                    RX671_func100(change_endian_long(0x8ff838f2u), change_endian_long(0x5cbdaab3u), change_endian_long(0x110c5baau), change_endian_long(0x0c4e3f7eu));
                    TSIP.REG_C4H.WORD = 0x000c2b0du;
                    TSIP.REG_E0H.WORD = 0x81040080u;
                    TSIP.REG_00H.WORD = 0x00002813u;
                    /* WAIT_LOOP */
                    ...
                    OutData_KeyIndex3[14] = TSIP.REG_100H.WORD;
                    OutData_KeyIndex3[15] = TSIP.REG_100H.WORD;
                    RX671_func100(change_endian_long(0x5c27f40eu), change_endian_long(0x4308c929u), change_endian_long(0x9f7ad957u), change_endian_long(0x0e3c3246u));
                    TSIP.REG_C4H.WORD = 0x000c2b0du;
                    TSIP.REG_E0H.WORD = 0x81040000u;
                    TSIP.REG_00H.WORD = 0x00002813u;
                    /* WAIT_LOOP */
                    ...
                    OutData_KeyIndex4[14] = TSIP.REG_100H.WORD;
                    OutData_KeyIndex4[15] = TSIP.REG_100H.WORD;
                    RX671_func101(change_endian_long(0x60a83e74u), change_endian_long(0x81df1e68u), change_endian_long(0xc0467f46u), change_endian_long(0x4ce79bf1u));
                }
                RX671_func100(change_endian_long(0x1ba4c685u), change_endian_long(0x4c856a2bu), change_endian_long(0xdbe49061u), change_endian_long(0x343a1b47u));
                TSIP.REG_D0H.WORD = 0x00000100u;
                ...
                RX671_func101(change_endian_long(0xbe46a4d4u), change_endian_long(0x575f31c1u), change_endian_long(0xfb00d15du), change_endian_long(0xf4650dffu));
            }
            RX671_func100(change_endian_long(0x4b9a19a9u), change_endian_long(0x1b246aefu), change_endian_long(0x08c83680u), change_endian_long(0x9e059e3cu));
            ...
            RX671_func102(change_endian_long(0xb6298963u), change_endian_long(0x8be0e162u), change_endian_long(0x9b7d0b47u), change_endian_long(0xaf264447u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p5f.prc
 *********************************************************************************************************************/
