...
void RX671_func032(void)
{
    ...
    RX671_func100(change_endian_long(0xf1809261u), change_endian_long(0xcbc4e398u), change_endian_long(0xce0bb573u), change_endian_long(0x3c0cd91eu));
    ...
    for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 1)
    {
        ...
        RX671_func101(change_endian_long(0x313c6397u), change_endian_long(0xfb01198au), change_endian_long(0xdb9d1e3fu), change_endian_long(0xeb4704e9u));
    }
    TSIP.REG_ECH.WORD = 0x00007c0du;
    TSIP.REG_1CH.WORD = 0x00602000u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0x70769841u), change_endian_long(0x933dd0ffu), change_endian_long(0x9857c9a1u), change_endian_long(0x42320f2au));
    TSIP.REG_ECH.WORD = 0x00007c01u;
    TSIP.REG_1CH.WORD = 0x00600000u;
}
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_func032.prc
 *********************************************************************************************************************/
