...
e_tsip_err_t R_TSIP_GenerateFirmwareMacInitSub(uint32_t *InData_KeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV)
{
    ...
    else
    {
        ...
        RX671_func101(change_endian_long(0x21dbf247u), change_endian_long(0xf911027du), change_endian_long(0x88cb549cu), change_endian_long(0x1b5342d1u));
        return TSIP_SUCCESS;
    }
}
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p23i.prc
 *********************************************************************************************************************/
