...
e_tsip_err_t R_TSIP_GenerateFirmwareMacUpdateSub(uint32_t *InData_UpProgram, uint32_t *OutData_Program, uint32_t MAX_CNT)
{
    ...
    RX671_func101(change_endian_long(0xfcb85060u), change_endian_long(0x59e3a54du), change_endian_long(0xfd15d665u), change_endian_long(0xea910b57u));
    return TSIP_SUCCESS;
}
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p23u.prc
 *********************************************************************************************************************/
