...
*******************************************************************************************************************/ /**
* @details       RX671 Program integrity check Init
* @retval        TSIP_SUCCESS
...
e_tsip_err_t R_TSIP_VerifyFirmwareMacInitSub(void)
{
    ...
    RX671_func101(change_endian_long(0xc56985ebu), change_endian_long(0xb248da15u), change_endian_long(0x50c5834bu), change_endian_long(0xb3859689u));
    return TSIP_SUCCESS;
}
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p26i.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
