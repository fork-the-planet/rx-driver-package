...
*******************************************************************************************************************/ /**
* @details       RX231HU F/W update Final
...
e_tsip_err_t R_TSIP_GenerateFirmwareMacFinalSub(uint32_t *InData_UpProgram, uint32_t *InData_UpMAC, uint32_t *OutData_Program, uint32_t *OutData_MAC, uint32_t MAX_CNT)
{
    ...
    {
        RX231_RX23W_function001(change_endian_long(0x2e558c10u), change_endian_long(0xbbf4eda1u), change_endian_long(0xe3137fb4u), change_endian_long(0xd8a3ffb9u));
        ...
        RX231_RX23W_function002(change_endian_long(0xe5c86a5eu), change_endian_long(0x6a2f1fefu), change_endian_long(0xd2dfe279u), change_endian_long(0x5db9fc6au));
    }
    RX231_RX23W_function001(change_endian_long(0xf25ba322u), change_endian_long(0x2cf82d2eu), change_endian_long(0x4f6a0a4fu), change_endian_long(0xf2eb1c87u));
    TSIP.REG_104H.WORD = 0x00000361u;
    TSIP.REG_A4H.WORD = 0x00d049adu;
    /* WAIT_LOOP */
    while (1u != TSIP.REG_104H.BIT.B31)
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX231_RX23W_function001(change_endian_long(0x8a86477au), change_endian_long(0x1099cdb1u), change_endian_long(0xcdbec6b0u), change_endian_long(0x69831ca6u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX231_RX23W_function003(change_endian_long(0x5f98da58u), change_endian_long(0x34e3a46au), change_endian_long(0x7aec823eu), change_endian_long(0xef29851cu));
    ...
    {
        RX231_RX23W_function001(change_endian_long(0xdc85a4c3u), change_endian_long(0x1104f649u), change_endian_long(0xff477597u), change_endian_long(0x0b038306u));
        ...
        RX231_RX23W_function003(change_endian_long(0xef78a5cau), change_endian_long(0x0f897f39u), change_endian_long(0x8951341du), change_endian_long(0xd24d0d1fu));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX231HU/RX231HU_p24f.prc
 *********************************************************************************************************************/
