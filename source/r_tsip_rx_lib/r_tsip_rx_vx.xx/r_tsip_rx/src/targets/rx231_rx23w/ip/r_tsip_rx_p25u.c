...
*******************************************************************************************************************/ /**
* @details       RX231HU Program integrity check Update
...
e_tsip_err_t R_TSIP_VerifyFirmwareMacUpdateSub(uint32_t *InData_Program, uint32_t MAX_CNT)
{
    ...
    RX231_RX23W_function002(change_endian_long(0xb4754073u), change_endian_long(0xe1ab527bu), change_endian_long(0xacfafc28u), change_endian_long(0x33f34832u));
    #if TSIP_MULTI_THREADING == 1
...
/**********************************************************************************************************************
 End of function ./input_dir/RX231HU/RX231HU_p25u.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
