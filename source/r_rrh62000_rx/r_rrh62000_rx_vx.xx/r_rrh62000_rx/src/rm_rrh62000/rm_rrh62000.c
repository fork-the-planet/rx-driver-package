...
#define RM_RRH62000_OPEN                          (((uint32_t)'R' << 24U) | ((uint32_t)'H' << 16U) | ((uint32_t)'6' << 8U) | ((uint32_t)'2' << 0U)) // Open state, R"RH62"000
...
#define RM_RRH62000_COMMAND_FWVER                 (0x75)
 ...
 * To check measurement status polling can be used.
                                                  ...
                                                  uint8_t * const                     p_cleaning_status)
{
    ...
    /* Send the command and receive the cleaning status */
                                                       ...
                                                       uint8_t * const                     p_raw_data)
{
    ...
    /* Send the command and receive the error codes, measurement data and checksum */
    write_read_params.p_src      = &p_ctrl->write_buf[0];
    write_read_params.src_bytes  = 1;
    write_read_params.p_dest     = p_ctrl->p_read_data;
    write_read_params.dest_bytes = p_ctrl->read_bytes;
...
static fsp_err_t rm_rrh62000_read_status (rm_rrh62000_instance_ctrl_t * const p_ctrl, uint8_t * const p_status)
{
    ...
    /* Send the command and receive the measurement status */
    write_read_params.p_src      = &p_ctrl->write_buf[0];
    write_read_params.src_bytes  = 1;
    write_read_params.p_dest     = p_ctrl->p_read_data;
    write_read_params.dest_bytes = p_ctrl->read_bytes;
                                                    ...
                                                    uint8_t * const                     p_version)
{
    ...
    /* Write the command */
    p_ctrl->write_buf[0] = RM_RRH62000_COMMAND_FWVER;

    /* Set pointer and read bytes */
    p_ctrl->p_read_data = p_version;
    p_ctrl->read_bytes  = 2;

    /* Send the command and receive the firmware version */
    write_read_params.p_src      = &p_ctrl->write_buf[0];
    write_read_params.src_bytes  = 1;
    write_read_params.p_dest     = p_ctrl->p_read_data;
    write_read_params.dest_bytes = p_ctrl->read_bytes;
                                                     ...
                                                     uint8_t * const                     p_version)
{
    ...
    /* Send the command and receive the algorithm version */
    write_read_params.p_src      = &p_ctrl->write_buf[0];
    write_read_params.src_bytes  = 1;
    write_read_params.p_dest     = p_ctrl->p_read_data;
    write_read_params.dest_bytes = p_ctrl->read_bytes;
