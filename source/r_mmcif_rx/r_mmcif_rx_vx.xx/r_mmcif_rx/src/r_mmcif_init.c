 ...
 *            See section R_MMCIF_Open() in the application note for details.\n
 ...
 * @note      The pins must be set up after this function is called. See section R_MMCIF_Close() in application note
 *            for details.
