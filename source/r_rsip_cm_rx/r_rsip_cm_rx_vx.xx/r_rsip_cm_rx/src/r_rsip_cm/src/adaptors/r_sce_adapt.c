...
fsp_err_t HW_SCE_McuSpecificInit(void)
{
    ...
    if (FSP_SUCCESS == iret)
    {
        ...
        SCE.REG_0018H.WORD = R_RSIP_LITTLE_ENDIAN_MODE;
        SCE.REG_001CH.WORD = R_RSIP_LITTLE_ENDIAN_MODE;
...
void HW_SCE_McuSpecificClose(void)
{
    R_BSP_RegisterProtectDisable(BSP_REG_PROTECT_LPC_CGC_SWR);
                                                ...
                                                uint32_t Header_Len)
{
    ...
    return (HW_SCE_Aes128CcmEncryptInitSub(InData_KeyType, InData_TextLen,
            InData_KeyIndex, NULL, InData_IV, InData_Header, Header_Len));
}
...
fsp_err_t HW_SCE_Aes192CcmEncryptFinalSub(const uint32_t *InData_Text, const uint32_t *InData_TextLen,
...
fsp_err_t HW_SCE_Aes192CcmDecryptFinalSub(const uint32_t *InData_Text, const uint32_t *InData_TextLen,
                                                ...
                                                uint32_t Header_Len)
{
    ...
    return (HW_SCE_Aes256CcmEncryptInitSub(InData_KeyType, InData_KeyIndex,
                                            NULL, InData_IV, InData_Header, Header_Len));
}
                                                ...
                                                uint32_t Header_Len)
{
    ...
    return (HW_SCE_Aes128CcmDecryptInitSub(InData_KeyType, InData_TextLen, InData_MACLength,
                                InData_KeyIndex, NULL, InData_IV, InData_Header, Header_Len));
}
                                                ...
                                                uint32_t Header_Len)
{
    ...
    FSP_PARAMETER_NOT_USED(InData_MACLength);
    FSP_PARAMETER_NOT_USED(InData_SeqNum);
    return (HW_SCE_Aes256CcmDecryptInitSub(InData_KeyType, InData_KeyIndex,
                                            NULL, InData_IV, InData_Header, Header_Len));
}
...
fsp_err_t HW_SCE_Ecc256ScalarMultiplicationSubAdaptor(const uint32_t InData_CurveType[],
                                                    ...
                                                    uint32_t OutData_R[])
{
    return (HW_SCE_Ecc256ScalarMultiplicationSub(InData_CurveType, InData_KeyMode, InData_KeyIndex,
                                                NULL, InData_PubKey, InData_DomainParam, OutData_R));
}
...
{
        uint32_t indata_key_mode = 0;
        uint32_t curvetype       = 0;
        indata_key_mode          = change_endian_long(*InData_Cmd);
        curvetype                = (*InData_CurveType);
        if (SCE_OEM_KEY_TYPE_PLAIN == *InData_Cmd)
        {
            return (HW_SCE_EcdsaSignatureGenerateSub(&curvetype, &indata_key_mode, NULL,
                    InData_KeyIndex, InData_MsgDgst, InData_DomainParam, OutData_Signature));
        }
        else
        {
            return (HW_SCE_EcdsaSignatureGenerateSub(&curvetype, &indata_key_mode,
                    InData_KeyIndex, NULL, InData_MsgDgst, InData_DomainParam, OutData_Signature));
        }
}
...
{
    FSP_PARAMETER_NOT_USED(InData_Cmd);
    uint32_t curvetype = (*InData_CurveType);
    return (HW_SCE_EcdsaSignatureVerificationSub(&curvetype, InData_KeyIndex,
                                                    ...
                                                    uint32_t *OutData_PrivKey)
{
    ...
    return (HW_SCE_GenerateEccRandomKeyIndexSub(InData_KeyType, InData_CurveType, InData_DomainParam,
                                                OutData_PubKey, OutData_PrivKeyIndex, OutData_PrivKey));
}
