                                           ...
                                           uint32_t OutData_Text[])
{
    ...
    HW_SCE_p_func100(0x21b882a7U, 0x2a7e454bU, 0x757f5568U, 0x36e1a3d8U);
    WR1_PROG(REG_0040H, 0x00400000U);
    WR1_PROG(REG_0024H, 0x00000000U);

    if (CHCK_STS(REG_0040H, 22, 1))
    {
        HW_SCE_p_func102(0x1061b975U, 0x13361254U, 0x169c907bU, 0x59383022U);
    ...
    else
    {
        ...
        HW_SCE_p_func100(0xc651ee9dU, 0x47e1d3d3U, 0xcbe1e9dfU, 0xe4844bddU);
        WR1_PROG(REG_0040H, 0x00400000U);
        WR1_PROG(REG_0024H, 0x00000000U);
        ...
        if (CHCK_STS(REG_0040H, 22, 1))
        {
            ...
            HW_SCE_p_func100(0xbfdd549dU, 0x4d5db19dU, 0x4f1a7c87U, 0x4d67bf4aU);
            WR1_PROG(REG_0094H, 0x00000821U);
            ...
            HW_SCE_p_func101(0x25c587c2U, 0xe9bc35f4U, 0x3271f5d8U, 0x7f76579fU);
        }
        else
        {
            HW_SCE_p_func101(0x84d863bbU, 0xa24f9702U, 0x2a801bfdU, 0x8b9ebebaU);
        }
        ...
        HW_SCE_p_func100(0xe4a7bc3bU, 0xbb9df976U, 0x57c3af92U, 0x19f2b935U);
        WR1_PROG(REG_0040H, 0x00400000U);
        WR1_PROG(REG_0024H, 0x00000000U);

        if (CHCK_STS(REG_0040H, 22, 1))
        {
            HW_SCE_p_func102(0x51ee670bU, 0xa542b8e8U, 0x9d2534cfU, 0xba590be2U);
        ...
        {
            HW_SCE_p_func102(0x11cffa74U, 0x56cb6a29U, 0xcde1cdc8U, 0xa2469626U);
            WR1_PROG(REG_006CH, 0x00000040U);
            WAIT_STS(REG_0020H, 12, 0);
