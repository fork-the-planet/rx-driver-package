...
static int sce_aes_cipher_final(mbedtls_cipher_context_t *ctx)
{
    ...
    /* Once final is successful, change operation state back to
     * SCE_MBEDTLS_CIPHER_OPERATION_STATE_INIT to allow same AES key to
...
#endif /* (BSP_FEATURE_RSIP_SCE9_SUPPORTED || BSP_FEATURE_RSIP_SCE5B_SUPPORTED ||
        *   BSP_FEATURE_RSIP_SCE5_SUPPORTED || BSP_FEATURE_RSIP_SCE7_SUPPORTED ||
        *   BSP_FEATURE_RSIP_RSIP_E51A_SUPPORTED || BSP_FEATURE_RSIP_RSIP_E11A_SUPPORTED )
        *   && MBEDTLS_AES_C && MBEDTLS_AES_ALT */
