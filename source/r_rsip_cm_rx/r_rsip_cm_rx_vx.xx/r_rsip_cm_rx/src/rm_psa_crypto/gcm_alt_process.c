                                ...
                                uint32_t * hashed_ivec)
{
    ...
    {
        /* Encrypt 4 words (128 bit) zeros with the AES key.
         * The generated cipher is the hash subkey used by GHASH HW API. */
                        ...
                        unsigned char       * tag)
{
    ...
    if (FSP_SUCCESS == err)
    {
        ...
        {
            err = g_sce_aes_gcm_encrypt_final[key_len_idx]((uint32_t *)gcm_buffer, data_bit_size, aad_bit_size,
        ...
        else
        {
            ...
            err = g_sce_aes_gcm_decrypt_final[key_len_idx]((uint32_t *)gcm_buffer, data_bit_size,
