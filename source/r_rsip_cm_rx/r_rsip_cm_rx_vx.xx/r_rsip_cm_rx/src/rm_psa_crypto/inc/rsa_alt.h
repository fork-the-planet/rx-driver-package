...
#define RSA_WRAPPPED_PRIVATE_CRT_KEY_SIZE_BYTES(RSA_SIZE_BITS)    ((RSA_PLAIN_TEXT_CRT_KEY_SIZE_BYTES(RSA_SIZE_BITS)) \
    ...
    #define SCE_RSA_NUM_TRIES_20480    (20480U) // Double the "NIST FIPS 186-4 recommended value for 2048-bit
                                                // key generation"due to empirically observed periodic failure
