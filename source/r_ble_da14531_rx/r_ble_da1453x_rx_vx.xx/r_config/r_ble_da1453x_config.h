...
#define GPIO_PORT_(p)   GPIO_PORT_##p
#define GPIO_PIN_(p)    PIN_##p
#define _GPIO_COMBINE(port, pin)   GPIO_PORT_##port##_PIN_##pin
#define GPIO_COMBINE(port, pin)    _GPIO_COMBINE(port, pin)
...
#define BLE_CFG_RESET_GPIO     GPIO_COMBINE(BLE_CFG_RESET_PORT, BLE_CFG_RESET_PIN)
...
Please refer to User's Manual:
 https://www.renesas.com/products/microcontrollers-microprocessors/rx-32-bit-performance-efficiency-mcus/rtk5rx6710c00000bj-target-board-rx671

Note3:
- When you use RX66N Target Board, you need remodeling of the board to use SCI channel 5(TXD5/RXD5/CTS5) and GPIO(PC1).
Please refer to User's Manual:
 https://www.renesas.com/products/microcontrollers-microprocessors/rx-32-bit-performance-efficiency-mcus/rtk5rx66n0c00000bj-target-board-rx66n
...
*/
#define BLE_CFG_HOST_BOOT_MODE                      (1)

/* Option BLE DA1453x
DA14531 = DA14531 device is selected
DA14535 = DA14535 device is selected
*/
#define BLE_CFG_DA1453X_DEVICE (DA14535_DEVICE)
...
BLE_GAP_SEC_MITM_BEST_EFFORT = Attempts to use MITM protection if supported by the peer,
                               still accepts connections without MITM.
...
*/
#define BLE_ABS_CFG_ENABLE_SECURE_DATA              (1)

/* Specifies the data flash block number to be used for secure bonding data storage*/
#define BLE_ABS_CFG_SECURE_DATA_DATAFLASH_BLOCK     (1)
...
*/
#define BLE_DA1453x_SLEEP_FLOW_CONTROL     (1)

/* Enables or disables cryptographic operations for the DA1453X platform.
- 0: Disable cryptographic operations.
- 1: Enable cryptographic operations (required for secure data handling and encryption)
*/
