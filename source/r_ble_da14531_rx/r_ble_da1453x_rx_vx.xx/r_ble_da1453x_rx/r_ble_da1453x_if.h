...
#ifndef R_BLE_DA1453X_IF_H
#define R_BLE_DA1453X_IF_H
 ...
 */
#define BLE_VERSION_MAJOR      (0x0001)

/**
 * @def BLE_VERSION_MINOR
 * BLE Module Minor Version.
 */
#define BLE_VERSION_MINOR      (0x0070)
...
typedef enum
{
     ...
     *                  <td class="paramname">BLE_ERR_RSP_TIMEOUT(0x0011)</td>
     *                  <td>30 seconds or more have passed without receiving a read response
     *                      since GATT Client sent a request for read by R_BLE_GATTC_ReadMultiChar()
     *                      to the GATT Server.
     *                  </td>
     *              </tr>
     *          </table>
     ...
     *                  <td class="paramname">BLE_ERR_RSP_TIMEOUT(0x0011)</td>
     *                  <td>30 seconds or more have passed without receiving a write response
     *                      since GATT Client sent a request for write by R_BLE_GTL_GATTC_WriteCharWithoutRsp()
     *                      to the GATT Server.
     *                  </td>
     *              </tr>
     *          </table>
    ...
    /**
     *  @brief  This event notifies the application layer that a service changed indication
 ...
 *          If the address is "AA:BB:CC:DD:EE:FF", 
 *          set the byte array in the order {0xFF, 0xEE, 0xDD, 0xCC, 0xBB, 0xAA}.
 *********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
 ...
 *  @brief This structure notifies that information about
 *  remote device has been retrieved by R_BLE_GAP_GetRemDevInfo().
 *********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
 ...
 *  @brief  This structure notifies that the local resolvable private address
 *          has been retrieved by R_BLE_GAP_ReadRpa().
 *********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
...
typedef enum
{
     ...
     *                      - When filter_dup field in scan_enable was 
     *                        BLE_GAP_SCAN_FILT_DUPLIC_ENABLE_FOR_PERIOD(0x02),
     ...
     *                  <td>
     *                      The request for a Periodic Sync establishment was cancelled by
 ...
 *  @brief  This structure notifies that write response to R_BLE_GATTC_WriteChar() 
 *          has been received from a GATT Server.
 *********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
 ...
 *          change the maximum transmission packet size or the maximum transmission time by
 *           @ref R_BLE_GAP_SetDataLen().
 *
 ...
 *          after allocating the memory for the data.
 ...
 *              Please refer to Figure 1.1 and Figure 1.2 about examples of setting advertising
 ...
 * @details Send synchronization information about the periodic advertising
 ...
 * @brief   This function set the default parameter of Periodic advertising sync transfer
 *          for all subsequent connection. It does not affect any existing connection.
 * @details
 ...
 * @retval  BLE_ERR_INVALID_HDL(0x000E) The GATT Server specified by conn_hdl was not found.
 *********************************************************************************************************************/
ble_status_t R_BLE_GATTC_WriteLongChar(uint16_t conn_hdl, st_ble_gatt_hdl_value_pair_t * p_write_data,
                                       uint16_t offset);
 ...
 *          If the auto_flag parameter has been set to BLE_GATTC_EXEC_NOT_AUTO,
 ...
 *                   Set BLE_GAP_ADDR_PUBLIC(0x00) or BLE_GAP_ADDR_RAND(0x01)
 *  to the type field in the p_addr parameter.
 * @retval  BLE_SUCCESS(0x0000) Success
 ...
 * @details When DA1453x goes into sleep deasserts its RTS. If RA CPU wishes to wake it up,
 *          it should toggle its RTS for
