...
*/
/***********************************************************************************************************************
* File Name    : r_rsip_hal.c
* Description  : Interface definition for the RSIP HAL layer.
***********************************************************************************************************************/
/**********************************************************************************************************************
 ...
 **********************************************************************************************************************/
static void set_sha2_final_block (const uint8_t * p_message, uint64_t message_length, uint64_t total_message_length,
...
{
    rsip_ret_t rsip_ret = r_rsip_p22();

    return rsip_ret;
}

void r_rsip_kuk_set(const void * p_key_update_key_value)
{
...
#else
    padded_buffer2[p_handle->buffered_length2 + zero_padding_len + 8] = total_bit_length.byte.pos_8th;
    padded_buffer2[p_handle->buffered_length2 + zero_padding_len + 7] = total_bit_length.byte.pos_7th;
    padded_buffer2[p_handle->buffered_length2 + zero_padding_len + 6] = total_bit_length.byte.pos_6th;
    padded_buffer2[p_handle->buffered_length2 + zero_padding_len + 5] = total_bit_length.byte.pos_5th;
    padded_buffer2[p_handle->buffered_length2 + zero_padding_len + 4] = total_bit_length.byte.pos_4th;
    padded_buffer2[p_handle->buffered_length2 + zero_padding_len + 3] = total_bit_length.byte.pos_3rd;
    padded_buffer2[p_handle->buffered_length2 + zero_padding_len + 2] = total_bit_length.byte.pos_2nd;
    padded_buffer2[p_handle->buffered_length2 + zero_padding_len + 1] = total_bit_length.byte.pos_1st;
#endif
...
#else
        p_last_block[SHA_BLOCK8_LEN - 1] = total_bit_length.byte.pos_8th;
        p_last_block[SHA_BLOCK8_LEN - 2] = total_bit_length.byte.pos_7th;
        p_last_block[SHA_BLOCK8_LEN - 3] = total_bit_length.byte.pos_6th;
        p_last_block[SHA_BLOCK8_LEN - 4] = total_bit_length.byte.pos_5th;
        p_last_block[SHA_BLOCK8_LEN - 5] = total_bit_length.byte.pos_4th;
        p_last_block[SHA_BLOCK8_LEN - 6] = total_bit_length.byte.pos_3rd;
        p_last_block[SHA_BLOCK8_LEN - 7] = total_bit_length.byte.pos_2nd;
        p_last_block[SHA_BLOCK8_LEN - 8] = total_bit_length.byte.pos_1st;
#endif
...
#else
        p_last_block[(2 * SHA_BLOCK8_LEN) - 1] = total_bit_length.byte.pos_8th;
        p_last_block[(2 * SHA_BLOCK8_LEN) - 2] = total_bit_length.byte.pos_7th;
        p_last_block[(2 * SHA_BLOCK8_LEN) - 3] = total_bit_length.byte.pos_6th;
        p_last_block[(2 * SHA_BLOCK8_LEN) - 4] = total_bit_length.byte.pos_5th;
        p_last_block[(2 * SHA_BLOCK8_LEN) - 5] = total_bit_length.byte.pos_4th;
        p_last_block[(2 * SHA_BLOCK8_LEN) - 6] = total_bit_length.byte.pos_3rd;
        p_last_block[(2 * SHA_BLOCK8_LEN) - 7] = total_bit_length.byte.pos_2nd;
        p_last_block[(2 * SHA_BLOCK8_LEN) - 8] = total_bit_length.byte.pos_1st;
#endif
