 ...
 ***********************************************************************************************************************/
RSIP_PRV_STATIC_INLINE(r_rsip_key_type_parse)
rsip_key_type_extend_t r_rsip_key_type_parse (rsip_key_type_t key_type)
{
 ...
 * @return Word length
 ***********************************************************************************************************************/
RSIP_PRV_STATIC_INLINE(r_rsip_byte_to_word_convert)
 ...
 * @return Byte length
 ***********************************************************************************************************************/
RSIP_PRV_STATIC_INLINE(r_rsip_word_to_byte_convert)
uint32_t r_rsip_word_to_byte_convert (const uint32_t words)
{
    return words << 2;
}
 ...
 ***********************************************************************************************************************/
RSIP_PRV_STATIC_INLINE(r_rsip_byte_to_bit_convert_upper)
 ...
 ***********************************************************************************************************************/
RSIP_PRV_STATIC_INLINE(r_rsip_byte_to_bit_convert_lower)
