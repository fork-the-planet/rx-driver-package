...
void r_rsip_func407(const uint32_t ARG1[])
{
    ...
    RSIP.REG_002CH.WORD = bswap_32big(0x0000f407U);
    RSIP.REG_0024H.WORD = 0x00000000U;
    r_rsip_func101(0x2a34b72cU, 0x9e84537fU, 0xb24c6d2aU, 0xa1297e8fU);
    r_rsip_func043();
    ...
    RSIP.REG_002CH.WORD = bswap_32big(0x0000f407U);
    RSIP.REG_0024H.WORD = 0x00000000U;
    r_rsip_func101(0x659b11d6U, 0x1589ceacU, 0x4f0bd00bU, 0xefa9dc80U);
    r_rsip_func044();
    ...
    RSIP.REG_0040H.WORD = 0x00001800U;
    RSIP.REG_0094H.WORD = 0x000034e0U;
