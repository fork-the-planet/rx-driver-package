...
rsip_ret_t r_rsip_p90(const uint32_t InData_Cmd[], const uint32_t InData_KeyIndex[], const uint32_t InData_WrappedKeyType[], const uint32_t InData_Text[], uint32_t KEY_INDEX_SIZE, uint32_t OutData_KeyIndex[], uint32_t WRAPPED_KEY_SIZE)
{
    ...
    else
    {
        ...
        RSIP.REG_002CH.WORD = bswap_32big(0x00009001U);
        RSIP.REG_0024H.WORD = 0x00000000U;
        ...
        else
        {
            ...
            else
            {
                ...
                RSIP.REG_002CH.WORD = bswap_32big(0x00009002U);
                RSIP.REG_0024H.WORD = 0x00000000U;
